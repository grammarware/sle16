...
public class While_EvaluableAspect extends Control_EvaluableAspect {
  ...
  public static Boolean evaluate(final While _self) {
    org.gemoc.arduino.sequential.execarduino.aspects.While_EvaluableAspectWhileAspectProperties _self_ = org.gemoc.arduino.sequential.execarduino.aspects.While_EvaluableAspectWhileAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.sequential.execarduino.arduino.While){
    					result = org.gemoc.arduino.sequential.execarduino.aspects.While_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.sequential.execarduino.arduino.While)_self);
