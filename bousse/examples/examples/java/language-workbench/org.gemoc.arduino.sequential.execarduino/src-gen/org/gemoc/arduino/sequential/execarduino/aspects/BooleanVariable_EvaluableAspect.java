...
public class BooleanVariable_EvaluableAspect extends Variable_EvaluableAspect {
  ...
  public static Object evaluate(final BooleanVariable _self) {
    org.gemoc.arduino.sequential.execarduino.aspects.BooleanVariable_EvaluableAspectBooleanVariableAspectProperties _self_ = org.gemoc.arduino.sequential.execarduino.aspects.BooleanVariable_EvaluableAspectBooleanVariableAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof org.gemoc.arduino.sequential.execarduino.arduino.BooleanVariable){
    					result = org.gemoc.arduino.sequential.execarduino.aspects.BooleanVariable_EvaluableAspect._privk3_evaluate(_self_, (org.gemoc.arduino.sequential.execarduino.arduino.BooleanVariable)_self);
