...
public class Project_ExecutableAspect {
  public static void execute(final Project _self) {
    org.gemoc.arduino.sequential.execarduino.aspects.Project_ExecutableAspectProjectAspectProperties _self_ = org.gemoc.arduino.sequential.execarduino.aspects.Project_ExecutableAspectProjectAspectContext.getSelf(_self);
  ...
  @InitializeModel
  public static void initializeModel(final Project _self, final List<String> args) {
    org.gemoc.arduino.sequential.execarduino.aspects.Project_ExecutableAspectProjectAspectProperties _self_ = org.gemoc.arduino.sequential.execarduino.aspects.Project_ExecutableAspectProjectAspectContext.getSelf(_self);
  ...
  protected static void _privk3_initializeModel(final Project_ExecutableAspectProjectAspectProperties _self_, final Project _self, final List<String> args) {
