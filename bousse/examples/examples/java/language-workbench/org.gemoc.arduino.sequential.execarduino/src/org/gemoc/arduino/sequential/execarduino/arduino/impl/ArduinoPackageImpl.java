...
import org.gemoc.arduino.sequential.execarduino.arduino.Assignment;
...
import org.gemoc.arduino.sequential.execarduino.arduino.NamedElement;
...
import org.gemoc.arduino.sequential.execarduino.arduino.Time;
...
public class ArduinoPackageImpl extends EPackageImpl implements ArduinoPackage {
	 ...
	 * @see org.gemoc.arduino.sequential.execarduino.arduino.ArduinoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		op = addEOperation(instructionEClass, ecorePackage.getEInt(), "youpla", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(instructionEClass, ecorePackage.getEInt(), "youpi", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEBoolean(), "yay", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(variableAssignmentEClass, ecorePackage.getEInt(), "youpla", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEBoolean(), "b", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(ledEClass, org.gemoc.arduino.sequential.execarduino.arduino.LED.class, "LED", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLED_Color(), this.getColor(), "color", "blue", 1, 1, org.gemoc.arduino.sequential.execarduino.arduino.LED.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (instructionEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (instructionEClass.getEOperations().get(3), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (variableAssignmentEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
