...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook" version="1.0">
    ...
    <!-- IMPORTS && INCLUDES -->
    <xsl:import href="http://docbook.sourceforge.net/release/xsl/1.76.1/eclipse/eclipse.xsl"/>
    <xsl:include href="common-xhtml.xsl"/>


    <!--
        From: xhtml/chunk-common.xsl
        Reason: remove tables, truncate link text, and add JBoss.org and Community Documentation graphics to top row
    -->
