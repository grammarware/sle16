...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- PARAMETERS -->
    <xsl:param name="siteHref" select="'http://www.gemoc.org'"/>
    <xsl:param name="docHref" select="'http://gemoc.github.io//'"/>
    <xsl:param name="siteLinkText" select="'GEMOC.org'"/>
    <xsl:param name="docLinkText" select="'Community Documentation'"/>

    <xsl:param name="html.stylesheet" select="'css/gemocorg.css'"/>
