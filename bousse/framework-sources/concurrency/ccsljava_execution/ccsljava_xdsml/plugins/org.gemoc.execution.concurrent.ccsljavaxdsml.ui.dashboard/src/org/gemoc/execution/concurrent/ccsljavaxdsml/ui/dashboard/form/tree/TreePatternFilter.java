 ...
 *******************************************************************************/
package org.gemoc.execution.concurrent.ccsljavaxdsml.ui.dashboard.form.tree;
...
import org.gemoc.execution.concurrent.ccsljavaxdsml.ui.dashboard.utils.PatternFilter;

/**
 * Pattern filter used in Tree displaying Capella concepts.<br>
 * This pattern filter automatically selects children of a parent that matches the filter even if children
 * labels don't match.
 */
public class TreePatternFilter extends PatternFilter {
	/**
	 * Flag used to ignore matching result when set.<br>
	 * When a parent matches the filter, this flag is set to <code>true</code> to automatically select its
	 * children.
	 */
	private boolean _ignoreMatching;

	/**
	 * Set of parent that match the filter either a parent has a label text that matches the filter or it is
	 * contained by a parent that matches the filter.
	 */
	...
	/**
	 * @see org.gemoc.gemoc_language_workbench.dashboard.utils.polarsys.capella.common.ui.toolkit.widgets.filter.PatternFilter#select(org.eclipse.jface.viewers.Viewer,
	...
	/**
	 * @see org.gemoc.gemoc_language_workbench.dashboard.utils.polarsys.capella.common.ui.toolkit.widgets.filter.PatternFilter#clearCaches()
	 */
	@Override
	 ...
	 * 
	 * @see org.gemoc.gemoc_language_workbench.dashboard.utils.polarsys.capella.common.ui.toolkit.widgets.filter.PatternFilter#isLeafMatch(org.eclipse.jface.viewers.Viewer,
	 *      java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	protected boolean doIsLeafMatch(Viewer viewer_p, Object parentElement_p, Object element_p) {
		...
		if (result) {
			// Get the parent from the content provider, parent and children in the tree may not be based on
			// model containment hierarchy.
			// Is current leaf, that matches the pattern filter, filtered out by other filters ?
			result = !isLeafAlreadyFilteredOutByOtherFilters((StructuredViewer)viewer_p, parentElement_p,
					element_p);
		}
		return result;
	}
	...
	/**
	 * @see org.gemoc.gemoc_language_workbench.dashboard.utils.polarsys.capella.common.ui.toolkit.widgets.filter.PatternFilter#isElementVisible(org.eclipse.jface.viewers.Viewer,
	 *      java.lang.Object, java.lang.Object)
	 */
	@Override
