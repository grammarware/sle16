 ...
 *******************************************************************************/
package org.gemoc.execution.concurrent.ccsljavaxdsml.ui.dashboard.form;
...
import org.gemoc.execution.concurrent.ccsljavaxdsml.ui.dashboard.utils.Couple;
...
public class FormHelper {
	 ...
	 * {@link #updateCompositeLayoutWithLayoutType(Composite, org.gemoc.gemoc_language_workbench.dashboard.form.polarsys.capella.common.mdsofa.common.ui.helper.FormHelper.LayoutType, int)}
	 * method.
	 * 
	 * @param toolkit_p
	 * @param parent_p
	 ...
	 * Requires at least a two columns layout so that both the label and the text are displayed on the same
	 * line.
	 * 
	 * @param toolkit_p
	 * @param parent_p
	 ...
	 * Requires at least a three columns layout so that the label, the text and the button are displayed on
	 * the same line.
	 * 
	 * @param toolkit_p
	 * @param parent_p
	 ...
	 *            can be <code>null</code>, if not necessary. Description is rendered as a tooltip.
	 * @param listener_p
	 */
	public static void createLinkWithDescription(FormToolkit toolkit_p, Composite parent_p, Image icon_p,
	...
	public static Couple<Section, Composite> createSectionWithChildComposite(FormToolkit toolkit_p,
			Composite parent_p, int sectionStyle_p, LayoutType layoutType_p, int childNumColumns_p,
	 ...
	 */
	public static Couple<Section, Composite> createSectionWithDescription(FormToolkit toolkit_p,
		...
		Couple<Section, Composite> createdSectionWithChildComposite = createSectionWithChildComposite(
				toolkit_p, parent_p, sectionStyle, LayoutType.GRID_LAYOUT, 1, true);
		// Get created section.
	 ...
	 * @return a {@link Couple} containing the child composite and the created section.
	 */
	public static Couple<Section, Composite> createTwistieSectionWithDescription(
			final IManagedForm managedForm_p, Composite parent_p, String title_p, String description_p) {
		// Create the section style.
	...
	public static Couple<Section, Composite> createTwistieSectionWithToolbar(Composite sectionContainer_p,
		...
		// Create the section.
		Couple<Section, Composite> createdSection = FormHelper.createTwistieSectionWithDescription(
				managedForm_p, sectionContainer_p, title_p, description_p);
	 ...
	 * {@link #updateControlLayoutDataWithLayoutTypeData(Composite, org.gemoc.gemoc_language_workbench.dashboard.form.polarsys.capella.common.mdsofa.common.ui.helper.FormHelper.LayoutType)}
	 * .
	 * 
	 * @param composite_p
	 * @param layoutType_p
	 ...
	 */
	public static void adaptBackgroundColor(Composite composite_p, Color color_p,
			boolean ignoreEditableTextField_p) {
		// Preconditions.
