 ...
 * <ul>
 *   <li>{@link org.gemoc.gel.impl.ExecutionFunctionImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.gemoc.gel.impl.ExecutionFunctionImpl#getCallKind <em>Call Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ExecutionFunctionImpl extends MinimalEObjectImpl.Container implements ExecutionFunction {
	 ...
	 * @ordered
	 */
	protected static final CallKind CALL_KIND_EDEFAULT = CallKind.NON_BLOCKING;
	/**
	...
	protected EClass eStaticClass() {
		return GelPackage.Literals.EXECUTION_FUNCTION;
	}
	...
	public NotificationChain basicSetResult(ExecutionFunctionResult newResult, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GelPackage.EXECUTION_FUNCTION__RESULT, oldResult, newResult);
	...
	public void setResult(ExecutionFunctionResult newResult) {
		if (newResult != result) {
			...
			if (result != null)
				msgs = ((InternalEObject)result).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GelPackage.EXECUTION_FUNCTION__RESULT, null, msgs);
			if (newResult != null)
				msgs = ((InternalEObject)newResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GelPackage.EXECUTION_FUNCTION__RESULT, null, msgs);
			msgs = basicSetResult(newResult, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GelPackage.EXECUTION_FUNCTION__RESULT, newResult, newResult));
	}
	...
	public void setCallKind(CallKind newCallKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GelPackage.EXECUTION_FUNCTION__CALL_KIND, oldCallKind, callKind));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GelPackage.EXECUTION_FUNCTION__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GelPackage.EXECUTION_FUNCTION__RESULT:
				return getResult();
			case GelPackage.EXECUTION_FUNCTION__CALL_KIND:
				return getCallKind();
		}
