 ...
 * <ul>
 *   <li>{@link org.gemoc.gel.impl.IterationPatternImpl#getNumberOfIterations <em>Number Of Iterations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IterationPatternImpl extends UnaryPatternImpl implements IterationPattern {
	...
	protected EClass eStaticClass() {
		return GelPackage.Literals.ITERATION_PATTERN;
	}
	...
	public void setNumberOfIterations(Integer newNumberOfIterations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GelPackage.ITERATION_PATTERN__NUMBER_OF_ITERATIONS, oldNumberOfIterations, numberOfIterations));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GelPackage.ITERATION_PATTERN__NUMBER_OF_ITERATIONS:
