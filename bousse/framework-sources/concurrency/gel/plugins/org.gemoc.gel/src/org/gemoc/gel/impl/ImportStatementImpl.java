 ...
 * <ul>
 *   <li>{@link org.gemoc.gel.impl.ImportStatementImpl#getImportURI <em>Import URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportStatementImpl extends MinimalEObjectImpl.Container implements ImportStatement {
	...
	protected EClass eStaticClass() {
		return GelPackage.Literals.IMPORT_STATEMENT;
	}
	...
	public void setImportURI(String newImportURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GelPackage.IMPORT_STATEMENT__IMPORT_URI, oldImportURI, importURI));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GelPackage.IMPORT_STATEMENT__IMPORT_URI:
				return getImportURI();
		}
