...
/**
 * This is the item provider adapter for a {@link org.gemoc.gel.microgel.ModelSpecificEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelSpecificEventItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelSpecificEvent_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelSpecificEvent_name_feature", "_UI_ModelSpecificEvent_type"),
				 MicrogelPackage.Literals.MODEL_SPECIFIC_EVENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicrogelPackage.Literals.MODEL_SPECIFIC_EVENT__VISIBILITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModelSpecificEvent.class)) {
			case MicrogelPackage.MODEL_SPECIFIC_EVENT__NAME:
			case MicrogelPackage.MODEL_SPECIFIC_EVENT__VISIBILITY:
