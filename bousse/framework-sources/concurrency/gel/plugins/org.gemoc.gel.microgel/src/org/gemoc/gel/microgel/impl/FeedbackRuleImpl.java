 ...
 * <ul>
 *   <li>{@link org.gemoc.gel.microgel.impl.FeedbackRuleImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.gemoc.gel.microgel.impl.FeedbackRuleImpl#getConsequence <em>Consequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeedbackRuleImpl extends MinimalEObjectImpl.Container implements FeedbackRule {
	...
	public NotificationChain basicSetFilter(FeedbackFilter newFilter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MicrogelPackage.FEEDBACK_RULE__FILTER, oldFilter, newFilter);
	...
	public void setFilter(FeedbackFilter newFilter) {
		if (newFilter != filter) {
			...
			if (filter != null)
				msgs = ((InternalEObject)filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MicrogelPackage.FEEDBACK_RULE__FILTER, null, msgs);
			if (newFilter != null)
				msgs = ((InternalEObject)newFilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MicrogelPackage.FEEDBACK_RULE__FILTER, null, msgs);
			msgs = basicSetFilter(newFilter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicrogelPackage.FEEDBACK_RULE__FILTER, newFilter, newFilter));
	}
	...
	public NotificationChain basicSetConsequence(FeedbackConsequence newConsequence, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MicrogelPackage.FEEDBACK_RULE__CONSEQUENCE, oldConsequence, newConsequence);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConsequence(FeedbackConsequence newConsequence) {
		if (newConsequence != consequence) {
			NotificationChain msgs = null;
			if (consequence != null)
				msgs = ((InternalEObject)consequence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MicrogelPackage.FEEDBACK_RULE__CONSEQUENCE, null, msgs);
			if (newConsequence != null)
				msgs = ((InternalEObject)newConsequence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MicrogelPackage.FEEDBACK_RULE__CONSEQUENCE, null, msgs);
			msgs = basicSetConsequence(newConsequence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicrogelPackage.FEEDBACK_RULE__CONSEQUENCE, newConsequence, newConsequence));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MicrogelPackage.FEEDBACK_RULE__FILTER:
				return basicSetFilter(null, msgs);
			case MicrogelPackage.FEEDBACK_RULE__CONSEQUENCE:
