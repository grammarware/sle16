 ...
 * <ul>
 *   <li>{@link org.gemoc.gel.microgel.impl.FeedbackPolicyImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link org.gemoc.gel.microgel.impl.FeedbackPolicyImpl#getDefaultRule <em>Default Rule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeedbackPolicyImpl extends MinimalEObjectImpl.Container implements FeedbackPolicy {
	...
	protected EClass eStaticClass() {
		return MicrogelPackage.Literals.FEEDBACK_POLICY;
	}
	...
	public EList<FeedbackRule> getRules() {
		if (rules == null) {
			rules = new EObjectContainmentEList<FeedbackRule>(FeedbackRule.class, this, MicrogelPackage.FEEDBACK_POLICY__RULES);
		}
		return rules;
	}
	...
	public NotificationChain basicSetDefaultRule(FeedbackRule newDefaultRule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MicrogelPackage.FEEDBACK_POLICY__DEFAULT_RULE, oldDefaultRule, newDefaultRule);
	...
	public void setDefaultRule(FeedbackRule newDefaultRule) {
		if (newDefaultRule != defaultRule) {
			...
			if (defaultRule != null)
				msgs = ((InternalEObject)defaultRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MicrogelPackage.FEEDBACK_POLICY__DEFAULT_RULE, null, msgs);
			if (newDefaultRule != null)
				msgs = ((InternalEObject)newDefaultRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MicrogelPackage.FEEDBACK_POLICY__DEFAULT_RULE, null, msgs);
			msgs = basicSetDefaultRule(newDefaultRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicrogelPackage.FEEDBACK_POLICY__DEFAULT_RULE, newDefaultRule, newDefaultRule));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MicrogelPackage.FEEDBACK_POLICY__RULES:
				return ((InternalEList<?>)getRules()).basicRemove(otherEnd, msgs);
			case MicrogelPackage.FEEDBACK_POLICY__DEFAULT_RULE:
