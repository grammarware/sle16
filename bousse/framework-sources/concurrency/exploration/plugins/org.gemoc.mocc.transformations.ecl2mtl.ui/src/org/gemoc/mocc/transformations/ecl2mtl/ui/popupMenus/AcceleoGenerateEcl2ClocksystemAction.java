 ...
 *******************************************************************************/
package org.gemoc.mocc.transformations.ecl2mtl.ui.popupMenus;
...
import org.gemoc.mocc.transformations.ecl2mtl.ui.common.GenerateAll;
import org.gemoc.mocc.transformations.ecl2mtl.ui.common.GenerateEcl2Clocksystem;
import org.eclipse.ui.IActionDelegate;
import org.eclipse.ui.PlatformUI;
import org.eclipse.ui.actions.ActionDelegate;

/**
 * ecl2mtl code generation.
 */
public class AcceleoGenerateEcl2ClocksystemAction extends ActionDelegate implements IActionDelegate {
	 ...
	 * Generation folder
	 */
	public static final String GEN_FOLDER="mtl-gen";
					...
					try {
						...
						while (filesIt.hasNext()) {
							...
							try {
								...
								GenerateEcl2Clocksystem generator = new GenerateEcl2Clocksystem(modelURI, target, getArguments());
	...
	protected List<? extends Object> getArguments() {
		...
		try {
			...
			String targetFileName = uri.lastSegment().replace(".ecl",	"_");
