 ...
 * @generated
 */
public class BFlowSwitch<T> extends Switch<T>
{
	/**
	...
	{
		switch (classifierID) {
			case BFlowPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BFlowPackage.MODELINPUT: {
				modelinput modelinput = (modelinput)theEObject;
				T result = casemodelinput(modelinput);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BFlowPackage.FLOWS: {
				Flows flows = (Flows)theEObject;
				T result = caseFlows(flows);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BFlowPackage.LAUNCHER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>modelinput</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>modelinput</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
